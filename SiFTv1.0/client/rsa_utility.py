...
if __name__ == '__main__':
    ...
    if operation == 'kpg':
        ...
        encrypt_message('test_pubkey.pem', 'plaintext.txt', 'encrypted.bin', 'test_keypair.pem', sign=False)
    elif operation == 'dec':
        decrypt_message('test_keypair.pem', 'encrypted.bin', 'decrypted.txt', 'test_pubkey.pem', sign=False,passphrase='crysys')
    else:
